...
function init_epos_gateway() {
	...
	class Wordpress_epos_Expresspay extends WC_Payment_Gateway {
		...
		public function __construct() {
            ...
            $this->method_title = $this->get_option('payment_methid_title');//__('Экспресс Платежи: EPOS');
